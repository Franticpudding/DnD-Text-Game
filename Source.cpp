...
int amountCorrectFood;
string cabbageAmount;
bool cabbageWhile;
...
void penelopeQuest()
{
    cout << "\n Penelope quest begins (Not finished yet, apologies)\n";
...
void pickApples()
{
    while (!treeWhile)
    {
        cout << yellow << "\n Narrator: " << normal << "You walk towards a field, three fruit trees sit there, " << yellow << "apple" << normal << ", " << yellow << "orange" << normal << " and " << yellow << "pear" << normal;
        cout << yellow << "\n\n Which tree do you pick from? " << normal;
    ...
    cout << yellow << "\n Narrator: " << normal << "You store them in your coat pocket";
...
void pickCabbage()
{
    ...
    while (!cabbageWhile)
    {
        cout << yellow << "\n Narrator: " << normal << "As you walk towards the cabbage patch, you see a " << yellow << "maximum" << normal << " of 20 cabbages.           ";
        cout << "\n\n  " << yellow << "How many do you pick? " << normal;
        cin >> cabbageAmount;

        if (cabbageAmount == "4")
        {
            cabbageScore = cabbageScore + 10;
            pickCabbagesQuestFinished = true;
            break;
        }
        else if (cabbageAmount == "1" || cabbageAmount == "2" || cabbageAmount == "3" || cabbageAmount == "5" || cabbageAmount == "6" || cabbageAmount == "7" || cabbageAmount == "8" || cabbageAmount == "9" || cabbageAmount == "10" || cabbageAmount == "11" || cabbageAmount == "12" || cabbageAmount == "13" || cabbageAmount == "14" || cabbageAmount == "15" || cabbageAmount == "16" || cabbageAmount == "17" || cabbageAmount == "18" || cabbageAmount == "19" || cabbageAmount == "20")
        {
            cabbageScore = cabbageScore + 0;
            pickCabbagesQuestFinished = true;
            break;
        }
        else
        {
            cout << "\n\n   Please enter a " << yellow << "valid " << normal << "number\n";
            enter();
            cin.ignore();
            system("CLS");
            pickCabbagesQuestFinished = false;
        }
    }

    cout << yellow << "\n Narrator: " << normal << "You stash the cabbages in your satchel\n";
...
void collectSack()
{
    ...
    cout << yellow << "\n Narrator: " << normal << "You throw the sack over your back, and drop it off at the end of the path";
...
void foodShopQuest()
{
    ...
    cout << "\n";
    cout << R"###(                       __________________ )###";
    cout << "\n";
    cout << R"###(                      /                / \ )###";
    cout << "\n";
    cout << R"###(                      \________________\_/ )###";
    cout << "\n";
    cout << R"###(                        |                | )###";
    cout << "\n";
    cout << R"###(                        |     List:      | )###";
    ...
    cout << R"###(                        | 4 Cabbages     | )###";
    cout << "\n";
    cout << R"###(                        | 1 Sack of Flour| _ )###";
    cout << "\n";
    cout << R"###(                        |                |/ \ )###";
    cout << "\n";
    cout << R"###(                        \_________________\_/ )###";
    cout << "\n";

    cout << yellow << "\n\n Narrator: " << normal << "You turn left and walk towards the farm\n" << normal;
    ...
    while (!loopPickFood)
    {
        ...
        if (pickCabbagesQuestFinished == true && pickApplesQuestFinished == true && collectSackQuestFinished == true)
        {
            ...
            cout << yellow << "\n Narrator: " << normal << "You return from the farm, back down the rugged road until you reach the food shop. \n           After dropping off the items, she checks them, and pays you.";


            if (totalFoodScore == 0)
            {
                cout << yellow << "\n\n  Shop keeper: " << green << "You collected all of the wrong things... thanks for wasting my time!\n" << normal;
            }
            else if (totalFoodScore == 10)
            {
                amountCorrectFood = 1;
                cout << yellow << "\n\n  Shop keeper: " << green << "Laddie, you only got " << amountCorrectFood << " right, sorry but you can only have 10 coins.\n" << normal;
            }
            else if (totalFoodScore == 20)
            {
                amountCorrectFood = 2;
                cout << yellow << "\n\n  Shop keeper: " << green << "Thanks laddie, you got " << amountCorrectFood << " of them right. Take 20 coins.\n" << normal;
            }
            else if (totalFoodScore == 30)
            {
                amountCorrectFood = 3;
                cout << yellow << "\n\n  Shop keeper: " << green << "Oh wow, thanks laddie! You got all " << amountCorrectFood << " right. Take 30 coins for your troubles.\n" << normal;
            }
...
{
    cout << yellow << "\n Narrator: " << normal << "Do you want to buy some rations? (Y / N): ";
    cin >> buyStockQ1;
    ...
    {
        cout << yellow << "\n  Shop keeper: " << green << "Okay, no worries!\n";
        whereGo1 = false;
    }
    ...
    while (!townWhile)
    {
        ...
        else if (locationChoice1 == "The Food Shop" || locationChoice1 == "Food Shop")
        {
            ...
            if (alreadyEnteredFoodShop == true && alreadyEnteredFoodShop2 == !true)
            {
                ...
                cout << yellow << "\n\n  Shop keeper: " << green << "What kinda work ya' lookin for?" << normal;
                ...
                cout << yellow << "  Narrator: " << normal << "Do you want to start the food quest now? ";
                ...
                else if (startFoodShopQuesttf == false)
                {
                    ...
                    cout << yellow << "\n Narrator: " << normal << "Come back to do the food shop quest\n";
                    cin.ignore();
                    enter();
                    system("CLS");
                }
            ...
            if (alreadyEnteredFoodShop == false)
            {
                ...
                if (buyRations == true)
                {
                    ...
                    cout << yellow << "\n  Shop keeper: " << green << "Have a good day laddie!\n" << normal;
                    enter();
                    system("CLS");
                    buyRations = false;
                    buyRationsQ2 = false;
            ...
            if (alreadyEnteredFoodShop == true && alreadyEnteredFoodShop2 == true && alreadyEnteredFoodShop3 == true && testFood1 == false)
            {
                ...
                if (buyStockQ2 == false && foodShopQuestRedo == true && foodQuestCompleted == !true)
                {
                    cout << yellow << "\n  Do you want to start the food shop quest now? " << normal;
